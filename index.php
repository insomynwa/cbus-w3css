...
<!-- Main Slideshow -->
<div id="myCarousel" class="container container-small carousel slide" data-ride="carousel">
  <!-- Wrapper for slides -->
  <div id="cbusslideshow" class="carousel-inner" role="listbox">
    <div class="item active">
      <img id="slide01" class="" src="<?php echo get_option('cbusw3css_theme_option')['main_slideshow1']; ?>" alt="boat" style="width:100%;amin-height:350px;amax-height:600px;">
    </div>

    <div class="item">
      <img id="slide02" class="" src="<?php echo get_option('cbusw3css_theme_option')['main_slideshow2']; ?>" alt="boat" style="width:100%;amin-height:350px;amax-height:600px;">
    </div>
  
    <div class="item">
      <img id="slide03" class="" src="<?php echo get_option('cbusw3css_theme_option')['main_slideshow3']; ?>" alt="boat" style="width:100%;amin-height:350px;amax-height:600px;">
    </div>

    <div class="item">
      <img id="slide04" class="" src="<?php echo get_option('cbusw3css_theme_option')['main_slideshow4']; ?>" alt="boat" style="width:100%;amin-height:350px;amax-height:600px;">
    </div>

    <div class="item">
      <img id="slide05" class="" src="<?php echo get_option('cbusw3css_theme_option')['main_slideshow5']; ?>" alt="boat" style="width:100%;amin-height:350px;amax-height:600px;">
    </div>

    <div class="item">
      <img id="slide06" class="" src="<?php echo get_option('cbusw3css_theme_option')['main_slideshow6']; ?>" alt="boat" style="width:100%;min-height:350px;max-height:600px;">
    </div>
...
<div id="about" class="container container-small text-center">
  <div class="row">
    <h2>ABOUT</h2><br>
    <div class="col-sm-8">
      <h4>CBUS is made up of creative talent from a variety of disciplines and life experiences. We listen, we think, we strategize. We realize every one is unique and that key insights can come from anyone. Together, we work hard with an unstoppable dedication to integrity and creating success for our clients.</h4>
      <br>
...
<!-- Services -->
<div id="services" class="container container-small text-center">
  <h2>SERVICES</h2>
  <h4>With technology advancing at a rapid pace and constant changes taking place in the development community, we continuously evaluate the most recent trends that are creating a buzz in the development community. Therefore, CBUS offers various types of multimedia services such as</h4>
  <br>
  <?php
...
<!-- Clients -->
<div id="clients" class="container container-small bg-3 text-center"> 
  <h2>CLIENTS</h2>
...
<!-- Contact -->
<!-- Container -->
<div id="contact" class="container container-small bg-grey">
  <h2 class="text-center">CONTACT</h2>
  <div class="row">
    <div class="col-sm-5">
      <p>Swing by for a cup of coffee, or whatever.</p>
      <p><span class="glyphicon glyphicon-home"></span> Komplek Tytyan Kencana</p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Kavling Haji Ukar No. 24</p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Marga Mulya</p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;17126, Bekasi Utara</p>
      <p><span class="glyphicon glyphicon-envelope"></span> cbusmultimedia@gmail.com</p>
    </div>
...
<!-- Google Maps -->
<div id="cbusmap" class="container container-small">
